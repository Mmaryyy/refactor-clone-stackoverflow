...
`
const ExpectingField = styled.div`
`
const TagField = styled.div`
`
const SimilarField = styled.div`
`
      ...
      <Content>
        <form action="" onSubmit={e => e.preventDefault()}>
          <main className="question_form">
              ...
              <div className="body_field">
                <div className="body_flex">
                  <div className="body">
                    ...
                    <p>
                      You’re ready to
                      <Link to="#" className="info_link"> ask </Link>
                      a
                      <Link to="#" className="info_link"> programming-related question </Link>
                      and this form will help guide you through the process.
                    </p>
                    <p className="text_2">
                      Looking to ask a non-programming question? See
                      <Link to="#" className="info_link"> the topics here </Link>
                ...
                <div className="title_box">
                  <div className="title_top">
                    <div className="title_1">
                      <label for="title" className="s-label">
                        Title
                      </label>
                    </div>
                    <div className="title_2">
                      <div className="title_2_text">
                        <label for="title" className="ss-label">
                          Be specific and imagine you’re asking a question to
                          another person.
                        </label>
                      </div>
                      <div className="title_2_space"></div>
                    </div>
                  </div>
              ...
              <Sidebar>
                ...
                <div className="sidebar_bottom">
                  ...
                  <div className="sidebar_text">
                    <p className='text_1'>Your title should summarize the problem.</p>
                    <p>
              ...
              <div className="body_box">
                <div className="body_main">
                  <div className="body_column">
                    ...
                    <div className="body_bottom">text editor</div>
                  </div>
                  <button>Next</button>
                </div>
              </div>
              <div className="hide_toggle"></div>
            </ProblemField>

            <ExpectingField className="body_expecting">
              <div className="body_box">
                <div className="body_main">
                  <div className="body_column">
                    <div className="body_top">
            ...
            <TagField className="tag_field">
              <div className="tag_input">
                <div className='tag_box'>
                  <div className='tag_main'>
                    <div className='tag_margin'>
                      ...
                      <div className='tag_bottom'>
                        <div>
                          <input type="text" autoComplete='off' placeholder='e.g. (javascript css)'></input>
                        </div>
                      </div>
              ...
              <div className="sidebar_top">
                ...
                <div className="sidebar_bottom">
                  ...
                  <div className="sidebar_text">
                    ...
                    <Link to="#">Learn more about tagging</Link>
                  </div>
                </div>
              </div>
            </TagField>
                      ...
                      <div className="middle_box">
                        <button>
                          ...
                          <div>
                            ...
                            <svg aria-hidden="true" class="fc-light svg-icon iconArrowUpAlt" width="18" height="18" viewBox="0 0 18 18"><path d="m16.01 10.62-1.4 1.4L9 6.45l-5.59 5.59-1.4-1.41 7-7 7 7Z"></path></svg>
                            </div>
                            <div className='arrow-down'>
                            <svg aria-hidden="true" class="fc-light svg-icon iconArrowDownAlt" width="18" height="18" viewBox="0 0 18 18"><path d="m16.01 7.43-1.4-1.41L9 11.6 3.42 6l-1.4 1.42 7 7 7-7Z"></path></svg>
                            </div>
                          </div>
                        </button>
                        <div>
